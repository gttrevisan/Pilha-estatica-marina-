...
public class Main {
    public static void main(String[] args) {
        ...
        pilha.push(60); // Deve imprimir "Pilha.Pilha cheia"

        // Teste: Verificar o estado atual da pilha
        System.out.print("Teste 8 - Estado atual da pilha: ");
        pilha.printPilha(); // Output: Pilha.Pilha: 10 20 30 40 50
        ...
        pilha.printPilha(); // Output: Pilha.Pilha: 10 20 30
        ...
        pilha.printPilha(); // Deve imprimir "Pilha.Pilha vazia"
        ...
        System.out.println("Teste 15 - Removendo elemento de uma pilha vazia: " + pilha.pop()); // Deve imprimir "Pilha.Pilha vazia" e retornar -1
        ...
        pilha.printPilha(); // Output: Pilha.Pilha: 100 200
        ...
        pilha.printPilha(); // Output: Pilha.Pilha: 100 200 300 400 500
